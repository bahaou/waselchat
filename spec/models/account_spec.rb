...
RSpec.describe Account do
  ...
  describe 'usage_limits' do
    ...
    it 'returns WaselchatApp.max limits' do
      expect(account.usage_limits).to eq({ agents: WaselchatApp.max_limit, inboxes: WaselchatApp.max_limit })
    end
  end
  ...
  describe 'support_email' do
    ...
    it 'returns the support email from inbox if inbox value is present' do
      account.update(support_email: 'support@waselchat.com')
      with_modified_env MAILER_SENDER_EMAIL: 'hello@waselchat.com' do
        expect(account.support_email).to eq('support@waselchat.com')
      end
    end
    ...
    it 'returns the support email from ENV if inbox value is nil' do
      ...
      with_modified_env MAILER_SENDER_EMAIL: 'hello@waselchat.com' do
        expect(account.support_email).to eq('hello@waselchat.com')
      end
    end
