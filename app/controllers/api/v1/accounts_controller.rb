class Api::V1::AccountsController < Api::BaseController
  ...
  def show
    @latest_waselchat_version = ::Redis::Alfred.get(::Redis::Alfred::LATEST_WASELCHAT_VERSION)
  ...
  def validate_captcha
    raise ActionController::InvalidAuthenticityToken, 'Invalid Captcha' unless WaselchatCaptcha.new(params[:h_captcha_client_response]).valid?
  end
