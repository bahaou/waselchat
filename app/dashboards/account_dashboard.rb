...
class AccountDashboard < Administrate::BaseDashboard
  ...
  enterprise_attribute_types = if WaselchatApp.enterprise?
                                 {
  ...
  enterprise_show_page_attributes = WaselchatApp.enterprise? ? %i[limits all_features] : []
  ...
  enterprise_form_attributes = WaselchatApp.enterprise? ? %i[limits all_features] : []
  FORM_ATTRIBUTES = (%i[
    name
    locale
    status
