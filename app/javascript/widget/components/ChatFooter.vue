...
import { getContrastingTextColor } from '@waselchat/utils';
...
import { WASELCHAT_ON_START_CONVERSATION } from '../constants/sdkEvents';
...
export default {
  ...
  computed: {
    ...
    hideReplyBox() {
      const { allowMessagesAfterResolved } = window.waselchatWebChannel;
  ...
  methods: {
    ...
    startNewConversation() {
      ...
      IFrameHelper.sendMessage({
        event: 'onEvent',
        eventIdentifier: WASELCHAT_ON_START_CONVERSATION,
