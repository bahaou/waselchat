<template>
  <main
    ...
    :style="{ backgroundImage: 'url(\'/brand-assets/background.jpg\')', 'background-size':'cover' }"
  >
...
import { parseBoolean } from '@waselchat/utils';
...
export default {
  ...
  computed: {
    ...
    showGoogleOAuth() {
      return Boolean(window.waselchatConfig.googleOAuthClientId);
    },
    showSignupLink() {
      return parseBoolean(window.waselchatConfig.signupEnabled);
    },
  },
  created() {
