...
import {
  ...
  EditorState,
  Selection,
} from '@waselchat/prosemirror-schema';
import {
  suggestionsPlugin,
  triggerCharacters,
} from '@waselchat/prosemirror-schema/src/mentions/plugin';
...
<style lang="scss">
@import '~@waselchat/prosemirror-schema/src/styles/base.scss';
