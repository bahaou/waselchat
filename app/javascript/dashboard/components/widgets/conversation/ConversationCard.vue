<template>
  ...
  >
    ...
    >
      ...
      <h4
        class="fix-ltr conversation--user text-sm my-0 mx-2 capitalize pt-0.5 text-ellipsis font-medium overflow-hidden whitespace-nowrap w-[calc(100%-70px)] text-slate-900 dark:text-slate-100"
      >
        {{ currentContact.name }}
      </h4>
      <message-preview
  ...
  methods: {
    onCardClick(e) {
      ...
      if (e.metaKey || e.ctrlKey) {
        window.open(
          window.waselchatConfig.hostURL + path,
          '_blank',
