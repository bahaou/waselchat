module Enterprise::SuperAdmin::AppConfigsController
  ...
  def allowed_configs
    return super if WaselchatHub.pricing_plan == 'community'
  ...
  def internal_config_options
    %w[WASELCHAT_INBOX_TOKEN WASELCHAT_INBOX_HMAC_KEY ANALYTICS_TOKEN CLEARBIT_API_KEY DASHBOARD_SCRIPTS]
  end
end
