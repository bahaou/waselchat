module Redis::RedisKeys
  ...
  WASELCHAT_INSTALLATION_ONBOARDING = 'WASELCHAT_INSTALLATION_ONBOARDING'.freeze
  WASELCHAT_INSTALLATION_CONFIG_RESET_WARNING = 'WASELCHAT_CONFIG_RESET_WARNING'.freeze
  LATEST_WASELCHAT_VERSION = 'LATEST_WASELCHAT_VERSION'.freeze
