class Integrations::Csml::ProcessorService < Integrations::BotProcessorService
  ...
  def client_params(session_id)
    {
      bot_id: "waselchat-bot-#{conversation.inbox.id}",
      channel_id: "waselchat-bot-inbox-#{conversation.inbox.id}",
      user_id: session_id
    }
  end
  ...
  def bot_payload
    {
      id: "waselchat-csml-bot-#{agent_bot.id}",
      name: "waselchat-csml-bot-#{agent_bot.id}",
      default_flow: 'waselchat_bot_flow',
      flows: [
        {
          id: "waselchat-csml-bot-flow-#{agent_bot.id}-inbox-#{conversation.inbox.id}",
          name: 'waselchat_bot_flow',
